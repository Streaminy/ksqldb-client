...
var QueryHandler = /*#__PURE__*/function (_Handler) {
  (0, _inherits2["default"])(QueryHandler, _Handler);

  var _super = _createSuper(QueryHandler);
  ...
  (0, _createClass2["default"])(QueryHandler, [{
    key: "parseSuccessData",
    value: function parseSuccessData(parsedData) {
      var metadata = parsedData.shift();
      var columnNames = metadata.columnNames;
      var rows = [];
      parsedData.forEach(function (rawRow) {
        ...
        request.on("end", function () {
          if (_this.error) {
            ...
            try {
              ...
              if (_this.status === 200) {
                var data = _this.parseSuccessData(parsedData);
